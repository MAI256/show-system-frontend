...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/h3/dist/index.mjs';
import http, { Server } from 'node:http';
import { resolve, dirname, join as join$1 } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { withBase, withQuery, parseURL, withoutBase, joinURL, getQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, hasProtocol, decode } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/hookable/dist/index.mjs';
import https from 'node:https';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/unhead/dist/utils.mjs';
import { imageMeta } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/image-meta/dist/index.mjs';
import { negotiate } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/@fastify/accept-negotiator/index.js';
import getEtag from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/etag/index.js';
import { resolve as resolve$2, join, parse } from 'file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/ipx/node_modules/pathe/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/a.mukhamadiev/Documents/work/showsystem/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/a.mukhamadiev/Documents/work/showsystem/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/a.mukhamadiev/Documents/work/showsystem/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/a.mukhamadiev/Documents/work/showsystem/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/a.mukhamadiev/Documents/work/showsystem/frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/a.mukhamadiev/Documents/work/showsystem/frontend/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/a.mukhamadiev/Documents/work/showsystem/frontend/public"
      ]
    },
    "http": {
      "domains": []
...
const _9EnNC589d4_fWz03Jmzws2K_QnwWZjqte76KQtGhPrk = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/a.mukhamadiev/Documents/work/showsystem/frontend";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon/favicon.ico"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/favicon/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"192x192","href":"/favicon/icon-192.png"},{"rel":"icon","type":"image/png","sizes":"512x512","href":"/favicon/icon-512.png"},{"rel":"manifest","href":"/manifest.json"}],"style":[],"script":[],"noscript":[]};
...
const _DHQcez0TVqHnCHP9QYxrX_976RpMKfXBtzjnuITLkvc = (nitroApp) => {
...
const plugins = [
  _9EnNC589d4_fWz03Jmzws2K_QnwWZjqte76KQtGhPrk,
_DHQcez0TVqHnCHP9QYxrX_976RpMKfXBtzjnuITLkvc
];
...
const _4s0yi9 = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
function createIPX(userOptions) {
  const options = defu$1(userOptions, {
  ...
  const getSharp = cachedPromise(async () => {
    return await import('file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/sharp/lib/index.js').then(
      (r) => r.default || r
    );
  });
  const getSVGO = cachedPromise(async () => {
    const { optimize } = await import('file:///Users/a.mukhamadiev/Documents/work/showsystem/frontend/node_modules/svgo/lib/svgo-node.js');
    return { optimize };
  });
...
function resolveDirs(dirs) {
  if (!dirs || !Array.isArray(dirs)) {
    const dir = resolve$2(dirs || getEnv("IPX_FS_DIR") || ".");
    return [dir];
  }
  return dirs.map((dirs2) => resolve$2(dirs2));
}
...
const _fVQmzh = lazyEventHandler(() => {
...
const _lazy_hMK5zC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _4s0yi9, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_hMK5zC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _fVQmzh, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_hMK5zC, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hMK5zC, lazy: true, middleware: false, method: undefined }
];
