<template>
    <main class="privacy">
        <!-- Fractal Background -->
        <ClientOnly>
            <TheFractalBackground @raster-ready="handleBackgroundLoaded" />
        </ClientOnly>
        ...
        <div class="container">
            ...
            <section>
                ...
                <p>
                    ...
                    персональных данных, предпринимаемые Антон Логинов (далее —
                    Оператор).
                </p>
                <p>
                ...
                <p>
                    ...
                    веб-сайта
                    <a href="https://showsystem.productions"
                        >https://showsystem.productions</a
                    >.
                </p>
            </section>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    номера телефонов; username пользователя в
                                    telegram
                                </td>
                            </tr>
                            <tr>
            ...
            <section>
                ...
                <p>
                    ...
                    Оператора
                    <a href="mailto:privacy@showsystem.productions"
                        >privacy@showsystem.productions</a
                    >
            ...
            <section>
                ...
                <p>
                    ...
                    <a href="https://showsystem.productions/privacy"
                        >https://showsystem.productions/privacy</a
                    >.
                </p>
            </section>
        </div>
...
// SEO Meta tags
useHead({
    title: "Политика конфиденциальности — ShowSystem",
    meta: [
        {
            name: "description",
            content:
                "Политика в отношении обработки персональных данных ShowSystem",
        },
        {
            name: "robots",
